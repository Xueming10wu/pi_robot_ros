...
{
public:
    friend void jointStateUpdate(BlissRobotRos * p);
    ...
    //extraFeatures功能回调函数
    void extraFeaturesCB(const bliss_driver::ExtraFeaturesConstPtr &msg);
...
private:
    ...
    bliss_driver::ExtraFeatures extra_features_msg;
